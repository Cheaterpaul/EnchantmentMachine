...
public class ScrollWidget<T> extends AbstractScrollWidget {
    ...
    public static class ContentBuilder<T> {
        ...
        public ContentBuilder(WidgetFactory<T> widgetFactory, int width, BiFunction<Integer, Integer, Boolean> isXYInside) {
            this.width = width;
        ...
        public void addWidget(T widget) {
            this.helper.addChild(widgetFactory.create(widget, 0, 0, width, this.isXYInside), this.alignHeader);
        }
