...
public class EnchantmentBlockTileEntityRenderer extends TileEntityRenderer<StorageTileEntity> {
    ...
    public static final RenderMaterial TEXTURE_BOOK = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS, new ResourceLocation(REFERENCE.MODID, "entity/enchanting_table_book"));
